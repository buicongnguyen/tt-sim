    ...
    <div className="site-shell">
      ...
      <div className={chaptersOpen ? "book-layout chapters-open" : "book-layout"}>
        ...
        <aside className="book-sidebar" id="book-sidebar" aria-label="TT Sim Lab chapters">
          ...
          <div className="sidebar-shelf"><span>Keep beside the terminal</span><a href="./discussion.html">Discussion workbench <i>↗</i></a><a href="./discussion-architecture-interview.html">NPU architecture interview <i>↗</i></a><a href="./discussion-architecture-interview-qa.html">50-question NPU reader <i>↗</i></a><a href="./debug-low-level-kernel-flow.html">Low-level kernel Mermaid flow <i>↗</i></a><a href="./discussion-presentation.html">30-minute research deck <i>↗</i></a><a href="./discussion-quantization.html">LLM quantization guide <i>↗</i></a><a href="./discussion-blackhole-bringup.html">Blackhole bring-up chain <i>↗</i></a><a href="./discussion-blackhole-synchronization.html">Blackhole sync field guide <i>↗</i></a><a href="./discussion-transformer-blackhole-optimization.html">Transformer optimization chain <i>↗</i></a><a href="./CONTRIBUTION_ROADMAP.md">Contribution roadmap <i>↗</i></a><a href="./firmware-flow.html">Host → RISC firmware flow <i>↗</i></a><a href="./async-kernels.html">Async kernels + tile math <i>↗</i></a><a href="./huawei.html">Blackhole vs Huawei <i>↗</i></a><a href="./TENSTORRENT_GENERATION_COMPARISON.md">Generation report <i>↗</i></a><a href="./COMPILER_RUNTIME_CAPSTONE.md">Compiler capstone <i>↗</i></a><a href="./QUASAR_CLUSTER_LAB.md">Quasar cluster lab <i>↗</i></a><a href="./WSL_AGENT_HOST_DEVICE_DEBUGGING.md">WSL host/device trace <i>↗</i></a><a href="./TTSIM_DEBUGGING_PATH.md">Debugging playbook <i>↗</i></a></div>
        </aside>
