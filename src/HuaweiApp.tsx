  ...
  return (
    <div className="hwa-page">
      <header className="hwa-topbar">
        ...
        <nav aria-label="Page navigation"><a href="#flows">Data paths</a><a href="#matrix">Matrix</a><a href="#compiler">Compiler</a><a href="#sources">Sources</a><a className="back" href="./index.html#generations">← Generation study</a></nav>
      </header>
      ...
      <main>
        ...
        <section id="compiler" className="compiler-section">
          <div className="compiler-copy"><span>03 / ONE GRAPH, TWO LOWERINGS</span><h2>Y = ReLU(A × B + bias)</h2><p>Fusion is target-independent. Buffer placement, transfer overlap, post-op placement and synchronization are not.</p></div>
        ...
        <section id="sources" className="hwa-section sources-section-hwa">
          <div className="section-number">04</div><div className="section-intro"><span>PRIMARY EVIDENCE</span><h2>Trace the claim.<br/>Keep the caveat.</h2><p>Product facts come from official tables; architecture facts come from public programming documentation; the original Ascend 910 memory row is explicitly a Huawei-hosted technical paper.</p></div>
          <div className="hwa-sources">
            ...
            <a href="./BLACKHOLE_VS_HUAWEI_ASCEND.md"><span>07 · REPORT</span><strong>Full comparison record</strong><p>Scope, caveats, compiler implications and decision guide in Markdown.</p><i>↗</i></a>
          </div>
        </section>
      </main>
